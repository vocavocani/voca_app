...
public class GroupProblemFragment extends android.support.v4.app.Fragment {
    ...
    public static GroupProblemFragment getFragment() {
        Bundle bundle = new Bundle();
        GroupProblemFragment fragment = new GroupProblemFragment();
